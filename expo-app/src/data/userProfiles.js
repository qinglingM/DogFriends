    ...
    dogs: [
      {
        ...
        vaccine: { done: 3, pending: 1, daysUntilReminder: 12, nextName: '狂犬疫苗', nextDate: '2026-07-01' },
      },
    ],
  },
  可乐姐姐: {
    ...
    dogs: [
      {
        ...
        vaccine: { done: 4, pending: 0, daysUntilReminder: 45, nextName: '六联', nextDate: '2026-08-15' },
      },
    ],
  },
  布丁爸: {
    ...
    dogs: [
      {
        ...
        vaccine: { done: 2, pending: 2, daysUntilReminder: 5, nextName: '狂犬疫苗', nextDate: '2026-06-20' },
      },
    ],
  },
  栗子: {
    ...
    dogs: [
      {
        ...
        vaccine: { done: 3, pending: 1, daysUntilReminder: 20, nextName: '六联', nextDate: '2026-07-05' },
      },
    ],
  },
  阿黄爸爸: {
    ...
    dogs: [
      {
        ...
        vaccine: { done: 4, pending: 0, daysUntilReminder: 60, nextName: '六联', nextDate: '2026-08-20' },
      },
    ],
  },
  狗蛋爸爸: {
    ...
    dogs: [
      ...
      },
      {
        ...
        vaccine: { done: 2, pending: 2, daysUntilReminder: 7, nextName: '六联疫苗', nextDate: '2026-06-30' },
      },
    ],
  },
};
